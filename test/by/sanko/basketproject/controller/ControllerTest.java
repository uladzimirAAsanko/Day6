...
public class ControllerTest {
    ...
    public void init(){
        try {
            bookListDao.addBook(new Book( "JAVA_Methods_Prog", Collections.singletonList("Blinov"),2020 , 400));
            bookListDao.addBook(new Book( "Idiot", Collections.singletonList("Dostoevsky"),1869 , 667));
            bookListDao.addBook(new Book( "1984", Collections.singletonList("George Orwell"),1949 , 328));
            bookListDao.addBook(new Book( "The Master and Margarita", Collections.singletonList("Mikhail Bulgakov"),1967 , 384));
    ...
    public void testDoRequestAddBook() {
        ...
        Book actual = null;
        actual = bookListDao.findById(5).get();
    ...
    public void testDoRequestSortByName() {
        ...
        actual.add(new Book(3, "1984", Collections.singletonList("George Orwell"),1949 , 328));
        ArrayList<String> authors = new ArrayList<>();
        authors.add("Ivanov");
        authors.add("Sodorov");
        ...
        actual.add(new Book( 4,"The Master and Margarita", Collections.singletonList("Mikhail Bulgakov"),1967 , 384));
    ...
    public void testDoRequestRemove() throws DAOException {
        ...
        Optional<Book> expected = bookListDao.findById(5);
